...
```{r global_histograms, echo=FALSE, warning=FALSE, message=FALSE, fig.cap= "Histogram of all variables in the data set", fig.asp= .6}
...
```{r so2_fig, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Histogram of Sulfur Dioxide Predictor", fig.asp= 0.6}
...
```{r so2_resid, echo=FALSE, warnings = FALSE, fig.cap="Residual Plots of Linear Model Predicting Quality with Total Sulfur Dioxide ", fig.asp= .6}
...
```{r linear_resids, echo = FALSE, warnings= FALSE, message = FALSE, fig.cap="Plot of Residuals in Best Subset Linear Regression", fig.asp= .6}
print(linear_resid)
```
...
### Boosted Regression
Boosted regression also used.

### Model Selection
```{r mse_results, warning= FALSE, echo = FALSE, fig.asp= .6, fig.cap="Plot of Results of Different Regression Techniques"}
print(MSE_plot)
```
