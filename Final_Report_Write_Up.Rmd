...
The distribution of these different criteria can be seen below:

```{r global_histograms, echo=FALSE, warning=FALSE, message=FALSE, fig.subcap= "Global Histogram", fig.asp= .7}
...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.asp= .7}
...
### Model Selection
```{r warning= FALSE, echo = FALSE, fig.asp= .7}
print(MSE_plot)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.asp= .7}
